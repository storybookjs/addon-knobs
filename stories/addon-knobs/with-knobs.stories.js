...
export const OptionsKnob = () => {
  ...
  const optionRadio = options('Radio', valuesRadio, 'Tuesday', {
    display: 'radio',
  });
  ...
  const optionSelect = options('Select', valuesSelect, 'January', {
    display: 'select',
  });
  ...
  const optionsCheck = options('Check', valuesCheck, ['carrot'], {
    display: 'check',
  });
